...
export const ThemeToggleButton = () => (
  <div role='presentation' className='relative w-10 h-10 rounded-full'>
    ...
    <div className='relative z-10 pointer-events-auto'>
      <ThemeToggle className='bg-transparent hover:bg-transparent border-transparent rounded-full' />
    </div>

    {/* include shared GlassFilter svg once at root — renders hidden defs */}
